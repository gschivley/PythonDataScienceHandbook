...
[![Binder](https://mybinder.org/badge.svg)](https://mybinder.org/v2/gh/gschivley/PythonDataScienceHandbook/master?filepath=notebooks%2FIndex.ipynb)
...
- Launch a live notebook server with these notebooks using [binder](https://beta.mybinder.org/): [![Binder](https://mybinder.org/badge.svg)](https://mybinder.org/v2/gh/gschivley/PythonDataScienceHandbook/master?filepath=notebooks%2FIndex.ipynb)
